...
const faqs: Faq[] = [
  ...
  { id: "f4", category: "Accès", function: "", question: "Y a-t-il un parking sur place ?", answer: "Oui, un parking gratuit d'une centaine de places est disponible dans le domaine, à 3 min à pied de la salle de réception.", helpful: 24 } as unknown as Faq,

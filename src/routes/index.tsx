      ...
      <footer className="border-t border-border bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              { title: "Produit", links: [["Concept", "#concept"], ["Fonctionnalités", "#features"], ["Événements", "#events"], ["Tarifs", "#pricing"]] },
              { title: "Commencer", links: [["Créer un événement", "/auth"], ["J'ai un code", "/join"], ["Connexion", "/auth"]] },
              { title: "Moments", links: [["Mariage", "#types"], ["Baptême", "#types"], ["Anniversaire", "#types"], ["Baby shower", "#types"]] },
            ].map((col) => (
              <div key={col.title}>

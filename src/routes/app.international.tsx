      ...
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/70 backdrop-blur-2xl safe-top">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3.5">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate font-serif text-xl leading-tight">International</h1>
            <p className="mt-0.5 truncate text-[11px] text-muted-foreground">62 pays · 12 langues</p>
          </div>
      ...
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-6">
        ...
        <section>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {offices.map((o) => (
              <div key={o.city} className="rounded-[22px] bg-surface p-4 shadow-card ring-1 ring-border/60 transition-all duration-300 hover:ring-primary/30">

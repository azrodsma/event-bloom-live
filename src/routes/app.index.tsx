  ...
  return (
    <div className="w-full min-w-0 space-y-8 py-6 sm:space-y-10 lg:py-10">
      ...
      <section className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4 lg:grid-cols-6">
        ...
        <Link to="/app/create" className="tap col-span-1 rounded-[28px] bg-surface p-5 shadow-card ring-1 ring-border transition hover:-translate-y-1 hover:shadow-glow md:col-span-4 lg:col-span-1 lg:p-6">
        ...
        <Link to="/app/explore" className="tap col-span-2 rounded-[28px] bg-secondary-light p-5 shadow-card transition hover:-translate-y-1 hover:shadow-glow md:col-span-4 lg:col-span-1 lg:p-6">

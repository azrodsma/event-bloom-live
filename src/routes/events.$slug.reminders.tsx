    ...
    <div className="module-page">
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/70 backdrop-blur-2xl safe-top">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3.5">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate font-serif text-xl leading-tight">Relances invités</h1>
            <p className="mt-0.5 truncate text-[11px] text-muted-foreground">7 séquences programmées · 148 destinataires</p>
          </div>
      ...
      <main className="mx-auto max-w-3xl space-y-6 px-4 py-6">
        <section className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-foreground to-primary-dark p-7 text-white shadow-modal">
          ...
          <h2 className="mt-2 font-serif text-3xl leading-[1.05] sm:text-4xl">La bonne relance, au bon moment, par le bon canal.</h2>

      ...
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/70 backdrop-blur-2xl safe-top">
        <div className="mx-auto flex max-w-3xl items-center gap-3 px-4 py-3.5">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="truncate font-serif text-xl leading-tight">Assurance annulation</h1>
            <p className="mt-0.5 truncate text-[11px] text-muted-foreground">Opéré par Allianz Événements · agrément ORIAS 12 097 483</p>
          </div>
